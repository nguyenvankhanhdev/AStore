                      ...
                      <div class="row">
                        ...
                        <div class="col-10">
                          <div class="tab-content" id="nav-tabContent">
                            ...
                            @include('backend.admin.payment-settings.sections.paypal-setting')

                            {{-- @include('backend.admin.payment-settings.sections.stripe-setting')

                            @include('backend.admin.payment-settings.sections.razorpay-setting')

                            @include('backend.admin.payment-settings.sections.cod-setting') --}}
