                                ...
                                <table class="table table-striped table-hover table-md">
                                    ...
                                    @foreach ($order->orderDetails as $detail)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('product.details', ['slug' => $detail->variantColors->variant->product->slug]) }} "
                                                    target="_blank">
                                            ...
                                            <td class="text-center">
                                                {{ number_format($detail->total_price / $detail->quantity, 2) }}
                                ...
                                <div class="col-lg-4 text-right">
                                    <div class="invoice-detail-item">
                                        ...
                                        <div class="invoice-detail-value">
                                            {{ number_format($order->sub_total ?? $order->orderDetails->sum('total_price'), 2) }}
                                            {{ $settings->currency_icon ?? 'đ' }}
                                        </div>
                                    </div>
                                    <div class="invoice-detail-item">
