<div class="header">
    <div class="header-body">
        <div class="container flex-center">
            <div class="header-logo"><a href="{{ route('products.index') }}"><img src="/frontend/asset/img/logoAstore.jpg"
                        alt="logo"></a>
            </div>
                ...
                <form method="GET" action="{{ route('products.search') }}">
                    <div class="form-group">
                        <div class="form-search form-search-sm">
                            ...
                            <input class="form-search-input m-r-8" type="text" name="search"
        ...
        <div class="container">
            <div class="header-item">
                <ul class="flex text-center">
                    ...
                    <li class="b-b-600"><a
                            href="{{ route('products.category', ['categories' => 'iphone']) }}">iPhone</a></li>
                    <li class="b-b-600"><a href="{{ route('products.category', ['categories' => 'ipad']) }}">iPad</a>
                    </li>
                    <li class="b-b-600"><a
                            href="{{ route('products.category', ['categories' => 'macbook']) }}">Macbook</a></li>
                    <li class="b-b-600"><a
                            href="{{ route('products.category', ['categories' => 'apple-watch']) }}">Apple Watch</a>
                    </li>
                    <li class="b-b-600"><a
                            href="{{ route('products.category', ['categories' => 'phu-kien-linh-kien']) }}">Phụ Kiện -
                            Linh Kiện</a></li>
                </ul>
            </div>
        </div>
