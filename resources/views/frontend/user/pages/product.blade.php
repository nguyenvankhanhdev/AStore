                            ...
                            <div class="menu js-category-menu">
                                <div class="swiper">
                                    <div class="swiper-wrapper"> <a class="item swiper-slide active" data-ref="#block-1">Tất
                                            ...
                                            Pro 14”</a><a class="item swiper-slide" data-ref="#block-5">MacBook Pro
                                            16”</a><a class="item swiper-slide" data-ref="#block-6">Mac mini</a><a
                                            class="item swiper-slide" data-ref="#block-7">iMac</a><a
                                            class="item swiper-slide" data-ref="#block-8">MacBook Pro
                        ...
                        <div class="tab-pane active" id="block-1">
                            <div class="product-list">
                                @foreach ($products as $product)
                                    <div class="product">
                                        <div class="product__img"><a href="#"><img src="{{ $product->image }}"
                                                    alt=""></a></div>
                                        <div class="product__info">
                                            <div class="product__color"> <span
                                                    style="background-color: #6A737A;"></span><span
                                                    style="background-color: #E1E4E6;"></span></div>
                                            <h3 class="product__name">
                                                <div class="text">{{ $product->name }}</div><span
                                                    class="badge badge-xs badge-link">Mới</span>
                                            </h3>
                                            <div class="product__memory js-select">
                                                <div class="product__memory__item item active"><strong>128GB</strong></div>
                                                <div class="product__memory__item item"><strong>256GB</strong></div>
                                                <div class="product__memory__item item"><strong>512GB </strong></div>
                                            </div>
                                            <div class="product__price">
                                                <div class="text">Giá chỉ</div>
                                                <div class="price">{{ $product->price }}</div><strike
