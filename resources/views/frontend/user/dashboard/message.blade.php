                ...
                @else
                    @foreach ($messages as $message)
                                ...
                                <div class="content">
                                    ...
                                    <div class="message-time">
                                        @if ($message->created_at->isToday())
                                            ...
                                            <!-- Chỉ hiển thị giờ nếu là hôm nay -->
                                        @else
                                            {{ $message->created_at->format('d/m/Y g:i A') }}
                                            <!-- Hiển thị ngày và giờ nếu là ngày khác -->
                                        @endif
                                    </div>
                                </div>
                            </div>
                        @else
                            ...
                            <div data-message-id="{{ $message->id }}" class="message other"
                            ...
                            if (response.messages.length > 0) {
                                ...
                                `;
                                        ...
                                        const newMessageElement = $(
                                            '#messageList .message.other[data-message-id="' +
                                            messageId + '"]');
                                        newMessageElement[0].scrollIntoView({
                                            behavior: 'smooth',
                                            block: 'nearest'
                                        });
