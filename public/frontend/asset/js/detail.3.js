...
var lg_zoom_es5_Zoom = /** @class */ (function () {
...
/* harmony default export */ const lg_zoom_es5 = (lg_zoom_es5_Zoom);
//# sourceMappingURL=lg-zoom.es5.js.map

;// CONCATENATED MODULE: ./node_modules/lightgallery/plugins/autoplay/lg-autoplay.es5.js
/*!
 * lightgallery | 2.7.0 | October 9th 2022
 * http://www.lightgalleryjs.com/
 * Copyright (c) 2020 Sachin Neravath;
...
var lg_autoplay_es5_assign = function() {
    lg_autoplay_es5_assign = Object.assign || function __assign(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p)) t[p] = s[p];
        }
    ...
    return lg_autoplay_es5_assign.apply(this, arguments);
};
 ...
 */
var lg_autoplay_es5_Autoplay = /** @class */ (function () {
    function Autoplay(instance) {
        this.core = instance;
        // extend module default settings with lightGallery core settings
        this.settings = lg_autoplay_es5_assign(lg_autoplay_es5_assign({}, autoplaySettings), this.core.settings);
        return this;
    }
    Autoplay.prototype.init = function () {
        ...
        if (this.settings.slideShowAutoplay) {
            this.core.LGel.once(lg_autoplay_es5_lGEvents.slideItemLoad + ".autoplay", function () {
                _this.startAutoPlay();
            });
        }
        // cancel interval on touchstart and dragstart
        this.core.LGel.on(lg_autoplay_es5_lGEvents.dragStart + ".autoplay touchstart.lg.autoplay", function () {
            if (_this.interval) {
                _this.stopAutoPlay();
        ...
        this.core.LGel.on(lg_autoplay_es5_lGEvents.dragEnd + ".autoplay touchend.lg.autoplay", function () {
            if (!_this.interval && _this.pausedOnTouchDrag) {
                _this.startAutoPlay();
                _this.pausedOnTouchDrag = false;
            }
        });
        this.core.LGel.on(lg_autoplay_es5_lGEvents.beforeSlide + ".autoplay", function () {
        ...
        // restore autoplay if autoplay canceled from touchstart / dragstart
        this.core.LGel.on(lg_autoplay_es5_lGEvents.afterSlide + ".autoplay", function () {
    ...
    Autoplay.prototype.startAutoPlay = function () {
        ...
        this.core.LGel.trigger(lg_autoplay_es5_lGEvents.autoplayStart, {
        ...
        this.interval = setInterval(function () {
            ...
            _this.core.LGel.trigger(lg_autoplay_es5_lGEvents.autoplay, {
    ...
    Autoplay.prototype.stopAutoPlay = function () {
        if (this.interval) {
            this.core.LGel.trigger(lg_autoplay_es5_lGEvents.autoplayStop, {
                index: this.core.index,
            });
...
/* harmony default export */ const lg_autoplay_es5 = (lg_autoplay_es5_Autoplay);
//# sourceMappingURL=lg-autoplay.es5.js.map

;// CONCATENATED MODULE: ./node_modules/lightgallery/plugins/fullscreen/lg-fullscreen.es5.js
/*!
 * lightgallery | 2.7.0 | October 9th 2022
 * http://www.lightgalleryjs.com/
 * Copyright (c) 2020 Sachin Neravath;
...
var lg_fullscreen_es5_assign = function() {
    lg_fullscreen_es5_assign = Object.assign || function __assign(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
            for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p)) t[p] = s[p];
        }
    ...
    return lg_fullscreen_es5_assign.apply(this, arguments);
};
...
var FullScreen = /** @class */ (function () {
    function FullScreen(instance, $LG) {
        ...
        this.$LG = $LG;
        // extend module default settings with lightGallery core settings
        this.settings = lg_fullscreen_es5_assign(lg_fullscreen_es5_assign({}, fullscreenSettings), this.core.settings);
        return this;
    }
...
/* harmony default export */ const lg_fullscreen_es5 = (FullScreen);
//# sourceMappingURL=lg-fullscreen.es5.js.map

;// CONCATENATED MODULE: ./src/assets/scripts/components/detail/detail.js
/* provided dependency */ var detail_$ = __webpack_require__(19755);
...
document.addEventListener('DOMContentLoaded', function(event) {
    var detailHeaderGalleryMain = new core('.gallery-main', {
        slidesPerView: 1,
        spaceBetween: 0,
        navigation: {
            nextEl: '.swiper-button-next',
    ...
    var detailHeaderGalleryThumb = new core('.gallery-thumbs', {
        slidesPerView: 'auto',
        spaceBetween: 10,
    });
    ...
    detail_$(".swiper.gallery-main").click(function (e) {
        ...
        if (detail_$(e.target).hasClass("swiper-button-next")) {
            if (detailHeaderGalleryMain && detailHeaderGalleryMain.activeIndex == 6) {
                const gallery = document.querySelector('.js-gallery');
                const plugin = lightgallery_es5(gallery, {
    ...
    var propertiesGalleryMain = new core('.properties-gallery-main', {
        watchOverflow: true,
        watchSlidesVisibility: true,
        watchSlidesProgress: true,
    ...
    var propertiesMenu = new core('.properties__menu .swiper', {
        slidesPerView: 'auto',
    });

    function handleProperties() {
        var container = detail_$('.js-modal-properties');
        ...
        container
            .scroll(function() {
                var scrollDistance = detail_$(this).scrollTop();
                // Assign active class to nav links while scolling\
                block.each(function(i) {
                    if (detail_$(this).position().top <= scrollDistance) {
        ...
        function goToByScroll(id) {
            ...
            setTimeout(() => {
                detail_$('.c-modal').removeClass('c-modal--visible');
            }, 1000);
        }
        //Bắt sự kiện click và gọi hàm scroll
        detail_$('.properties__menu .swiper-slide').click(function(e) {
            e.preventDefault();
            detail_$('.properties__menu .swiper-slide').removeClass('active');
            detail_$(this).addClass('active');
            var index = detail_$('.properties__menu .swiper-slide').index(detail_$(this));
            propertiesMenu.slideTo(index, 800);
            propertiesMenu.update();
            var data = detail_$(this).attr('href');
            console.log(detail_$(this));
            goToByScroll(data);
        });
    }
    handleProperties();
...
window.addEventListener('load', function() {
    ...
    const fnAccordion = () => {
        var tabAccordion = detail_$('.accordion-tab');
        var detailQuestion = detail_$('.detail__question');
        if (detailQuestion.length > 0) {
            tabAccordion.each(function() {
                var btnAccordion = detail_$(this).find('.js-accordion-action');

                btnAccordion.click(function() {
                    const that = detail_$(this);
...
detail_$(document).ready(function(){

    var swiper = new core(".slideIncentives", {
        slidesPerView: 2,
        slidePerGroup: 2,
        spaceBetween: 12,
        speed: 900,
